...
namespace MediaPlus.Migrations
{
    ...
    [Migration("20250508123534_UpdatePaymentTypeTableName")]
    partial class UpdatePaymentTypeTableName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaPlus.DBModels.TemplateDetail", b =>
                {
                    ...
                    b.Property<int?>("ShowTemplateTempId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediaPlus.DBModels.TemplateDetail", b =>
                {
                    b.HasOne("MediaPlus.DBModels.ShowTemplate", null)
                        .WithMany("TempDetails")
                        .HasForeignKey("ShowTemplateTempId");
                });

            modelBuilder.Entity("MediaPlus.DBModels.ShowTemplate", b =>
                {
                    b.Navigation("TempDetails");
                });
